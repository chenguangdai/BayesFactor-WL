...
load(paste(getwd(), "/data/VI/VI_SNR_", SNR, "_lambda_", lambda, ".RData", sep = ""))
# load(paste(getwd(), "/data/mode/mode_SNR_", SNR, "_lambda_", lambda, ".RData", sep = ""))
